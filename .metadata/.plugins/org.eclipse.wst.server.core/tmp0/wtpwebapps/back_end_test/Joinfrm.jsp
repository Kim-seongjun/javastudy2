...
<body>
	...
	<section>
		...
		<div id="div_join">
		<div>
			<div style="text-align: center;"><b style="font-size: 30px;">홈쇼핑 회원 등록</b></div>
		</div>
			<form action="#">
				<table>
					<tr>
					...
					<tr>
						<td>가입일자</td>
						<td><input type="text" name="joindate" maxlength="20" id="joindate" value="${time1}"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
						<input type="submit" id="btn" value="회원가입" formaction="memberjoin">
						<input type="submit" id="select" value="조회" style="margin-left: 30px;" formaction="memberlist">
						</td>
					</tr>
				</table>
			</form>
